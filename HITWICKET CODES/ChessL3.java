...
class ChessL3{
        ...
        if(player == 1){
            if(command.equals("FR")){
                if(x>1 && y<3 && grid.get(x-2).get(y+2).contains("A") == false ){
                    ...
                    System.out.println("Cant move FR or invalid move");
                }
            }
                ...
                if(x>1 && y>1 && grid.get(x-2).get(y-2).contains("A") == false){
                    ...
                    System.out.println("Cant move FL or invalid move");
                }
            }
                ...
                if(x<3 && y<3 && grid.get(x+2).get(y+2).contains("A") == false){
                    ...
                    System.out.println("Cant move BR or invalid move");
                }
                ...
                if(x<3 && y>1 && grid.get(x+2).get(y-2).contains("A") == false){
                    ...
                    System.out.println("Cant move BL or invalid move");
                }
            }
        }
        else{
    ...
    static void moveH3(String hero,int x,int y,String command,int player){
        if(player == 1){
            if(command.equals("BL")){
                if(x<3 && y>0 && grid.get(x+2).get(y-1).contains("A") == false){
                    grid.get(x+2).set(y-1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+2);
                    a.add(y-1);
                    charPosP1.put(hero, a);
                    ...
                    System.out.println("Cant move BL ");
                }
            }
            else if(command.equals("BR")){
                if(x<3 && y<4 && grid.get(x+2).get(y+1).contains("A") == false){
                    grid.get(x+2).set(y+1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+2);
                    a.add(y+1);
                    ...
                    System.out.println("Cant move BR");
                }
            }
            else if(command.equals("FR")){
                if(x>1 && y<4 && grid.get(x-2).get(y+1).contains("A") == false){
                    grid.get(x-2).set(y+1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-2);
                    a.add(y+1);
                    ...
                    System.out.println("Cant move FR");
                }
            }
            else if(command.equals("FL")){
                if(x>1 && y>0 && grid.get(x-2).get(y-1).contains("A") == false){
                    grid.get(x-2).set(y-1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-2);
                    a.add(y-1);
                    ...
                    System.out.println("Cant move FL");
                }
            }
            else if(command.equals("LB")){
                if(x<4 && y>1 && grid.get(x+1).get(y-2).contains("A") == false){
                    grid.get(x+1).set(y-2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+1);
                    a.add(y-2);
                    charPosP1.put(hero, a);
                    ...
                    System.out.println("Cant move LB");
                }
            }
            else if(command.equals("LF")){
                if(x>0 && y>1 && grid.get(x-1).get(y-2).contains("A") == false){
                    grid.get(x-1).set(y-2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-1);
                    a.add(y-2);
                    ...
                    System.out.println("Cant move LF");
                }
            }
            else if(command.equals("RB")){
                if(x<4 && y<3 && grid.get(x+1).get(y+2).contains("A") == false){
                    grid.get(x+1).set(y+2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+1);
                    a.add(y+2);
                    ...
                    System.out.println("Cant move RB");
                }
            }
            else if(command.equals("RF")){
                if(x>0 && y<3 && grid.get(x-1).get(y+2).contains("A") == false){
                    grid.get(x-1).set(y+2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-1);
                    a.add(y+2);
                    ...
                    System.out.println("Cant move RF");
                }
            }
        }
        else{
            if(command.equals("FR")){
                if(x<3 && y>0 && grid.get(x+2).get(y-1).contains("B") == false){
                    grid.get(x+2).set(y-1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+2);
                    a.add(y-1);
                ...
                if(x<3 && y<4 && grid.get(x+2).get(y+1).contains("B") == false){
                    grid.get(x+2).set(y+1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+2);
                    a.add(y+1);
                ...
                if(x>1 && y<4 && grid.get(x-2).get(y+1).contains("B") == false){
                    grid.get(x-2).set(y+1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-2);
                    a.add(y+1);
                ...
                if(x>1 && y>0 && grid.get(x-2).get(y-1).contains("B") == false){
                    grid.get(x-2).set(y-1, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-2);
                    a.add(y-1);
                ...
                if(x<4 && y>1 && grid.get(x+1).get(y-2).contains("B") == false){
                    grid.get(x+1).set(y-2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+1);
                    a.add(y-2);
                ...
                if(x>0 && y>1 && grid.get(x-1).get(y-2).contains("B") == false){
                    grid.get(x-1).set(y-2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-1);
                    a.add(y-2);
                ...
                if(x<4 && y<3 && grid.get(x+1).get(y+2).contains("B") == false){
                    grid.get(x+1).set(y+2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x+1);
                    a.add(y+2);
                ...
                if(x>0 && y<3 && grid.get(x-1).get(y+2).contains("B") == false){
                    grid.get(x-1).set(y+2, grid.get(x).get(y));
                    ArrayList<Integer> a = new ArrayList<Integer>();
                    a.add(x-1);
                    a.add(y+2);
                ...
                if(chance == 1){
                   ...
                   chance ++; 
                    ...
                    if(elem[0].contains("P") == false && elem[0].contains("H") == false){
                        ...
                        }else if(elem[0].equals("H3")){
                            moveH3("A-" +elem[0], pos.get(0), pos.get(1), elem[1],1);
                        }else{
                ...
                if (chance == 2){
                    ...
                    if(elem[0].contains("P") == false && elem[0].contains("H") == false){
                        ...
                        if(elem[0].equals("H1")){
                            ...
                            moveH3("B-" +elem[0], pos.get(0), pos.get(1), elem[1],2);
                        }else{
